                                ...
                                <div class="card-body">
                                    <form method="POST" action="#">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" id="refreshRate" name="refresh_rate" type="number" required>
                                        </div>
                                        <div class="mb-3">
                                            <label for="responseTime">Response Time</label>
                                            <input class="form-control" id="responseTime" name="response_time" type="number" required>
                                        </div>
                                        <div class="mb-3">
